...
@Component({
  selector: 'app-dialog-danger-zone',
  templateUrl: './dialog-danger-zone.component.html',
  styleUrls: ['./dialog-danger-zone.component.scss']
})
export class DialogDangerZoneComponent implements OnInit {
