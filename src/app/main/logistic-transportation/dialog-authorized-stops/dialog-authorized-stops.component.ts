...
import { DialogVehicleTrackingAddGeoConfirmComponent } from '../../vehicle-tracking-system/dialog-vehicle-tracking-add-geo-confirm/dialog-vehicle-tracking-add-geo-confirm.component';

declare const google: any;

@Component({
  selector: 'app-dialog-authorized-stops',
  templateUrl: './dialog-authorized-stops.component.html',
  styleUrls: ['./dialog-authorized-stops.component.scss']
})
export class DialogAuthorizedStopsComponent implements OnInit {
