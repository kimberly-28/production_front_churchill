...
@Component({
  selector: 'app-dialog-route-tracking',
  templateUrl: './dialog-route-tracking.component.html',
  styleUrls: ['./dialog-route-tracking.component.scss']
})
export class DialogRouteTrackingComponent implements OnInit {
