...
@Component({
  selector: 'app-dialog-historic-dt',
  templateUrl: './dialog-historic-dt.component.html',
  styleUrls: ['./dialog-historic-dt.component.scss']
})
export class DialogHistoricDTComponent implements OnInit {
